...
# ── ALL CSS INLINED HERE — no external theme.py needed ────────────
st.markdown("""
<style>
...
.kpi-card .kpi-val {
    ...
    line-height: 1; margin-bottom: 3px; font-family: 'DM Mono', monospace;
}
.kpi-card .kpi-lbl {
...
.alert-pill {
    ...
    font-size: 0.8rem; font-weight: 600; color: var(--red); margin-bottom: 1rem;
}
.warn-pill {
    display: inline-flex; align-items: center; gap: 6px;
    background: #fffbeb; border: 1.5px solid #fde68a;
    border-radius: var(--radius-pill); padding: 6px 14px;
    font-size: 0.8rem; font-weight: 600; color: #92400e; margin-bottom: 1rem;
}
.ok-pill {
    display: inline-flex; align-items: center; gap: 6px;
...
.asset-card:hover {
    box-shadow: var(--shadow-md); border-color: var(--green-lt);
...
.edit-panel {
    ...
    border: 2px solid var(--green-lt); border-radius: var(--radius);
...
.chart-card {
    background: var(--white); border: 1.5px solid var(--border);
    border-radius: var(--radius); padding: 1rem 1rem 0.5rem 1rem;
    box-shadow: var(--shadow-sm);
}

.transition-card {
    background: var(--white); border: 1.5px solid var(--border);
    border-left: 4px solid var(--green-lt); border-radius: var(--radius);
    padding: 0.9rem 1.1rem; margin-bottom: 6px; box-shadow: var(--shadow-sm);
}
.transition-card.off { border-left-color: var(--coral); }
    ...
    <div style="margin-top:2rem; padding-top:1rem;
        ...
        <div style="background:rgba(216,243,220,0.1); border:1px solid rgba(216,243,220,0.15);
            ...
            <div style="margin-top:8px; display:flex; align-items:center; gap:6px;">
                ...
                <span style="font-size:0.7rem; color:rgba(216,243,220,0.6);">
                    Database connected
                </span>
            </div>
        </div>
